...
public class ReadFile {
    ...
    public String[][] readFileFromTextFile(){
		...
		for(int i = 0 ; i < 729 ; i++){
                    for(int k = 0 ; k < 11 ; k++){
                        if(R11_0_729_Tables[i][k].equalsIgnoreCase("1") || R11_0_729_Tables[i][k].equalsIgnoreCase("X") || 
                                R11_0_729_Tables[i][k].equalsIgnoreCase("2")){
